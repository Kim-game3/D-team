...
public class SetTriangleScript : MonoBehaviour
{
    ...
    [SerializeField] GameObject sunSeed;//晴れの種
    [SerializeField] GameObject rainSeed;//雨の種
    [SerializeField] GameObject ThunderSeed;//雷の種

    public GameObject[] spawnSeeds;//格納場所
